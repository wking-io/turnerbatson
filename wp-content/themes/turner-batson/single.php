...
get_header();
  ...
  <section class="pt-nav lg:pt-0">
    ...
    <div class="wrapper flex flex-col lg:flex-row-reverse lg:justify-between lg:items-start py-8 lg:mt-8">
      ...
      <div class="news-meta flex lg:flex-col lg:text-right lg:mr-8 lg:flex-no-shrink">
    ...
    <div class="wrapper lg:flex">
      <div class="flex lg:flex-col lg:text-right lg:mr-8 lg:flex-no-shrink opacity-0"><p><?php echo $date; ?></p></div>
      <div>
