...
// Project related.
var project                 = 'Turner Batson'; // Project Name.
var projectURL              = 'turnerbatson.test'; // Local project URL of your already running WordPress site. Could be something like local.dev or localhost:8888.
var productURL              = './'; // Theme/Plugin URL. Leave it like it is, since our gulpfile.js lives in the root folder.

// Translation related.
var text_domain             = 'turner-batson'; // Your textdomain here.
var translationFile         = 'turner-batson.pot'; // Name of the transalation file.
var translationDestination  = './languages'; // Where to save the translation files.
var packageName             = 'TurnerBatson'; // Package name.
var bugReport               = 'https://briantics.com/'; // Where can users report bugs.
...
var jsCustomFile            = 'theme'; // Compiled JS custom file name.
 ...
 */
 gulp.task('styles', function () {
    ...
    .pipe( sourcemaps.write ( './assets/build/' ) )
    ...
    .pipe( rename( { dirname: 'assets/build', suffix: '.min' } ) )
    .pipe( minifycss( {
      maxLineLen: 10
    }))
    .pipe( lineec() ) // Consistent Line Endings for non UNIX systems.
...
gulp.task( 'final', gulp.parallel( 'browser-sync', 'watch' ) );
  ...
  */
gulp.task( 'default', gulp.series( 'styles', 'vendorsJs', 'customJS', 'images', 'final' ) );
