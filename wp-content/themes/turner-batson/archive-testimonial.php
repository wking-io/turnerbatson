...
<section>
  <div class="wrapper testimonial-wrapper relative lg:flex pt-nav lg:pt-0">
    ...
    <div class="pb-8" data-load-more="testimonial">
      <ul class="my-8 lg:mt-0 lg:ml-8 flex flex-col md:flex-row md:flex-wrap lg:flex-col xl:flex-row justify-between list-reset testimonial-items" data-load-more-container>
      <?php if ( have_posts() ) :
